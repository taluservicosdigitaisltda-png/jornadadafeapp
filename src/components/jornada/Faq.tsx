...
const faqs = [
  { q: "O Pausa de Fé é um curso?", a: "Não. É um aplicativo com orações narradas, reflexões bíblicas curtas e recursos para você viver um pequeno momento com Deus pelo celular." },
  ...
  { q: "São exatamente 5 minutos por dia?", a: "A proposta central é uma pausa de aproximadamente cinco minutos. Existem conteúdos um pouco menores ou maiores para você escolher conforme o tempo disponível." },
  ...
  { q: "O aplicativo pertence a algum padre ou igreja?", a: "Não. Pausa de Fé é uma marca independente e não utiliza imagem, voz ou endosso de líderes religiosos." },
...
export function Faq() {
  ...
  return (
    <section className={`${container} py-14 lg:py-20`} aria-labelledby="faq-titulo">
      ...
      <h2 id="faq-titulo" className="mt-4 text-2xl text-ivory sm:text-3xl lg:text-4xl">Antes de começar sua pausa</h2>
